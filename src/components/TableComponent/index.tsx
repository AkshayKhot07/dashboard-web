    ...
    return (
      <div className="w-full overflow-x-auto">
        ...
        >
          ...
          <thead className={classNames("text-text-2")}>
            <tr
              className={classNames(
                "min-h-[50px] h-[50px] max-h-[50px]",
                ...
                return (
                  <th
                    ...
                    className={classNames(
                      ...
                      "text-primary-1000",
                      "bg-background-8",
                      "rtl:first:rounded-tr-xl ltr:first:rounded-tl-xl",
                      "rtl:last:rounded-tl-xl ltr:last:rounded-tr-xl",
                    )}
                  >
          ...
          {isLoading ? (
            ...
            <tbody className={classNames("bg-yellow-400")}>
              {columns?.length > 0 ? (
                  ...
                  >
                    {fields.map((field) => (
                      <td
                        ...
                        className={classNames(
                          field.headerClass,
                          `whitespace-normal text-sm font-normal px-1 transition-all ease-in-out duration-150 group-hover:bg-gray-100 bg-background-100`,
                          "my-1",
                        )}
                      >
                        {field.render
